...
extension Color {
    ...
    ///
    /// The hex string can include an optional alpha component in addition 
    /// to the red, green, & blue components.
    ///
    ...
    ///
    /// - Warning: If the hexadecimal string is invalid or cannot be parsed, 
    /// the initializer defaults to a white color with full opacity.
